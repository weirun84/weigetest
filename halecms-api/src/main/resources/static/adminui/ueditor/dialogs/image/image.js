...
(function () {
    ...
    function initTabs() {
        ...
        var cmsimg = editor.getContent();
        var cmsimgreg = RegExp(/baidu_picclass_log/);
        
        if ((img && img.tagName && img.tagName.toLowerCase() == 'img') || cmsimg.match(cmsimgreg)) {
            setTabFocus('remote');
        } else {
            setTabFocus('upload');
        }
    ...
    RemoteImage.prototype = {
        ...
        initContainer: function () {
            ...
            var cmsimg = editor.getContent();
            var cmsimgreg = RegExp(/baidu_picclass_log/);
            if (cmsimg.match(cmsimgreg)) {
                // 包含        
                var cmspicimg = cmsimg.split(",");
                this.setPic(cmspicimg[0]);
            }
        ...
        setPic: function (img) {
            ...
            /* 防止onchange事件循环调用 */
            if (img !== $G("url").value) $G("url").value = img;
            setAlign(align);
            this.setPreview();
            this.updateLocker();
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                data['iswatermark'] = $('input[name="iswatermark"]:checked ').val();
            });
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if (list[i] && list[i].url) {
                    ...
                    del.setAttribute('onclick', 'uedel("' + list[i].url + '",this)');
                    //结束
