...
UE.plugins['background'] = function(){
     ...
     * @date 2014-03-31
     */
    UE.plugins['simpleupload'] = function () {
        var me = this,
            isLoaded = false,
            containerBtn;
            ...
            function createTable(opt, tableWidth, tdWidth) {
                ...
                for (var r = 0; r < rowsNum; r++) {
                    ...
                    for (var c = 0; c < colsNum; c++) {
                        ...
                        //[MyNet]
                        html.push('<td width="' + tdWidth + '">' + (browser.ie ? domUtils.fillChar : '<br/>') + '</td>')
                    }
                    html.push('</tr>')
                }
    ...
    var uiUtils = baidu.editor.ui.uiUtils = {
        ...
        getClientRect: function (element){
            ...
            while ((doc = element.ownerDocument) !== document &&
                ...
                if (isWin) {
                    var isWinXP = navigator.userAgent.indexOf("Windows NT 5.1") > -1 || navigator.userAgent.indexOf("Windows XP") > -1;
                    if (isWinXP) {
                        var index = navigator.userAgent.indexOf("MSIE");
                        if (index >= 0) {
                            if (parseFloat(navigator.userAgent.substr(index + "MSIE".length)) == 8) {
                                break;
                            }
                        }
                    }
...
(function () {
    ...
    var iframeUrlMap = {
        ...
        'video': '~/dialogs/insertvideo/insertvideo.html'
    };

    //为工具栏添加按钮，以下都是统一的按钮触发命令，所以写在一起
    var btnCmds = ['undo', 'redo', 'formatmatch',
        'bold', 'italic', 'underline', 'touppercase', 'tolowercase',
        'strikethrough', 'subscript', 'superscript', 'source', 'indent', 'outdent','editfive','editsix',
        'blockquote', 'pasteplain', 'pagebreak', 'editone','edittwo','editthree','editfour','editseven',
        'selectall', 'print', 'preview', 'horizontal', 'removeformat', 'time', 'date', 'unlink','editeight',
        'insertparagraphbeforetable', 'insertrow', 'insertcol', 'mergeright', 'mergedown', 'deleterow',
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable', 'insertmusic', 'video'];
    ...
    var dialogBtns = {
        ...
        ok:['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'wordimage',
            'insertvideo', 'highlightcode', 'insertframe', 'edittip', 'edittable', 'edittd', 'scrawl', 'template', 'music', 'background', 'insertmusic', 'video']
